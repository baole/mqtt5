...
data object PingreqPacket : MqttPacket() {
    override val type = PacketType.PINGREQ
}

// ─────────────────── PINGRESP (13) ───────────────────

data object PingrespPacket : MqttPacket() {
...
data class AuthPacket(
    ...
    override val type = PacketType.AUTH
}
